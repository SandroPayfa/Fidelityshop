...

{
    ...
    public function addShop(Request $request){
        ...
        if ($edit_shop_form->isSubmitted()) {
            ...
            $vendor=($this->isGranted('ROLE_ADMIN'))?
                $this->getDoctrine()->getRepository(User::class)->findOneById($request->get('user_id')):
                $this->get('security.token_storage')->getToken()->getUser();
            $upd_shop->setUserId($vendor);
        ...
        return $this->render('shop/add_shop.html.twig', [
            'vendors' => $vendors,
            'add_shop_form' => $edit_shop_form->createView()
        ]);
    }
